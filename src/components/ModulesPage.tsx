  ...
  const modules = [
    {
      ...
      status: 'in-progress',
      type: 'video',
      topicKeys: ['module1.topic1', 'module1.topic2', 'module1.topic3']
    },
    {
      id: 2,
      ...
      status: 'completed',
      type: 'interactive',
      topicKeys: ['module2.topic1', 'module2.topic2', 'module2.topic3']
    },
    {
      id: 3,
      slug: 'disaster-deduction',
      ...
      status: 'in-progress',
      type: 'mixed',
      topicKeys: ['module3.topic1', 'module3.topic2', 'module3.topic3']
    },
    {
      id: 4,
      ...
      status: 'locked',
      type: 'simulation',
      topicKeys: ['module4.topic1', 'module4.topic2', 'module4.topic3']
    },
    {
      id: 5,
      slug: 'community-response',
      ...
      status: 'locked',
      type: 'interactive',
      topicKeys: ['module5.topic1', 'module5.topic2', 'module5.topic3']
    },
    {
      id: 6,
      slug: 'recovery-rehabilitation',
      titleKey: 'module6.title',
      descriptionKey: 'module6.description',
      progress: 0,
      duration: '90 min',
      students: 45,
      status: 'locked',
      type: 'mixed',
      topicKeys: ['module6.topic1', 'module6.topic2', 'module6.topic3']
    }
  ];
